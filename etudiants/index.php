            ...
            <div class="container">
                ...
                <div class="main-content">
                    ...
                    <div class="books-section">
                        <h2 class="section-title"><i class="ri-book-line"></i> Livres Disponibles</h2>
                        <div class="books-grid" id="availableBooks">
                            <!-- Livres disponibles seront ajoutés ici -->
                        </div>
        
                        <h2 class="section-title"><i class="ri-book-marked-line"></i> Livres Non Disponibles</h2>
                        <div class="books-grid" id="unavailableBooks">
                            <!-- Livres non disponibles seront ajoutés ici -->
                        </div>
                    </div>
                </div>
            </div>
